...
OUT=ROOT/'dist'
FILES=['index.html','support/index.html','terms/index.html','privacy/index.html','404.html','robots.txt','sitemap.xml','_headers','assets/styles.css','assets/talkbrief-icon.png','assets/favicon.png','assets/apple-touch-icon.png','assets/iphone-capture.png','assets/web-workspace.jpg']
